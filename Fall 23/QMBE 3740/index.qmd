---
title: "Xander Chapman" # change this to your name
...
about:
  ...
  links: 
    - icon: envelope
      text: Contact Me
      href: mailto:achapman03@hamline.edu # change to your email
    - icon: linkedin
      href: https://linkedin.com. # change to your linkedin address
    - icon: github
      href: https://github.com/achapathamline/ # change to your github address
    - icon: twitter
